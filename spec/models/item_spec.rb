  ...
  describe '商品の出品登録' do
    ...
    context '出品ができないとき' do
      ...
      it '配送料の負担の情報が「---」だと出品できない' do
        ...
        @item.valid?
        expect(@item.errors.full_messages).to include('Derively fee must be other than 0')
      end
      it '配送料の負担の情報が空欄だと出品できない' do
        @item.derively_fee_id = nil
        @item.valid?
        expect(@item.errors.full_messages).to include("Derively fee can't be blank", 'Derively fee is not a number')
      end
